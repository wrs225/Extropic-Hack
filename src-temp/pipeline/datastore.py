...
class ImageDataStore:
    ...
    def __init__(self, base_dir: Path = Path("s0_data")):
        """
    ...
    def save_results(
        ...
        if experiment_name:
            ...
            exp_dir = self.results_dir / f"experiment_{timestamp}"
    ...
    def list_experiments(self) -> List[Path]:
        ...
        return sorted(self.results_dir.glob("experiment_*"), reverse=True)
